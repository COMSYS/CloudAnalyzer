...
public class RegionDataAmountFragmentGeneralDown extends StatsDataAmountAbstract
{
    @Override
    public void onAttach(Context context)
    {
        ...
        sql_cloud = "SELECT day, year, bytes FROM aggregation_data WHERE region = ? AND direction = 0 " + trafficPropertyILP + " GROUP BY day, year ORDER BY year, day";
