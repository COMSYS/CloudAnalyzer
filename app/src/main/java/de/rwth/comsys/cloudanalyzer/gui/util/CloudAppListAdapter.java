...
public class CloudAppListAdapter extends BaseAdapter implements Serializable
{
    ArrayList<CloudAppEntry> elementList;
    float totalUpTraffic, totalDownTraffic;
    private Locale locale;

    public CloudAppListAdapter(List<CloudAppEntry> list, Locale locale, float totalUpTraffic, float totalDownTraffic)
    {
        this.locale = locale;
        ...
        for (CloudAppEntry app : list)
        {
            CloudAppEntry entry = app;
     ...
     */
    @Override
    public CloudAppEntry getItem(int position)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        CloudAppEntry item = getItem(position);
