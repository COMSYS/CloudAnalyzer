...
public class ServiceDataAmountFragmentGeneralUp extends StatsDataAmountAbstract
{
    @Override
    public void onAttach(Context context)
    {
        ...
        sql_cloud = "SELECT day, year, SUM(bytes) FROM aggregation_view WHERE serviceName = ? AND direction = 1" + trafficPropertyILP + " GROUP BY day, year ORDER BY year, day";
